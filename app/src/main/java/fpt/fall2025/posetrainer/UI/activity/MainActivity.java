...
import fpt.fall2025.posetrainer.UI.fragment.HomeFragment;
import fpt.fall2025.posetrainer.UI.fragment.MyWorkoutFragment;
import fpt.fall2025.posetrainer.UI.fragment.DailyFragment;
import fpt.fall2025.posetrainer.UI.fragment.ProfileFragment;
import fpt.fall2025.posetrainer.UI.fragment.CommunityFragment;
import fpt.fall2025.posetrainer.UI.fragment.NotificationFragment;
    ...
    public void navigateToDailyFragmentWithDay(int dayOfWeek) {
        ...
        if (dailyFragment != null && dailyFragment.isAdded()) {
            ...
            binding.getRoot().post(() -> {
                if (dailyFragment instanceof fpt.fall2025.posetrainer.UI.fragment.DailyFragment) {
                    ((fpt.fall2025.posetrainer.UI.fragment.DailyFragment) dailyFragment).selectDay(dayOfWeek);
                }
            });
        }
    }
