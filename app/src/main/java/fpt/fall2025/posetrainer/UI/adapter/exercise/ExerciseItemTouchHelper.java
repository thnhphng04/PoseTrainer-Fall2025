...
public class ExerciseItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    private fpt.fall2025.posetrainer.UI.adapter.workout.EditWorkoutAdapter adapter;

    public ExerciseItemTouchHelper(fpt.fall2025.posetrainer.UI.adapter.workout.EditWorkoutAdapter adapter) {
