...
/**
 * HighKneeOverlayView - Overlay view for High Knee exercise
 * Dựa trên logic từ project High Knee nghiên cứu
 */
class HighKneeOverlayView @JvmOverloads constructor(
    context: Context,
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        poseResult?.let { result ->
            ...
            if (landmarkList != null) {
                ...
                // Lấy các điểm landmark cần thiết cho High Knee
                val leftEar = lm(7)
                val rightEar = lm(8)
                ...
                // Hiển thị bộ đếm High Knee đúng/sai ở phía dưới cùng
                ...
                val correctText = "High Knee đúng: ${feedback?.correctCount ?: 0}"
                val incorrectText = "High Knee sai: ${feedback?.incorrectCount ?: 0}"
                val padding = 30f
