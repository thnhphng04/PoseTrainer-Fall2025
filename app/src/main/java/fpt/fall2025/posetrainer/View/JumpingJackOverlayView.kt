...
/**
 * JumpingJackOverlayView - Overlay view for Jumping Jack exercise
 * Dựa trên logic từ project JumpingJack nghiên cứu
 */
class JumpingJackOverlayView @JvmOverloads constructor(
    context: Context,
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        poseResult?.let { result ->
            ...
            // Vẽ các đường nối cho Jumping Jack
            ...
            // Vẽ nét đứt (dotted line) từ hip, knee, ankle xuống dưới
            ...
            drawDottedLine(leftHip.first, leftHip.second-80, leftHip.second+20)
            drawDottedLine(rightHip.first, rightHip.second-80, rightHip.second+20)
            drawDottedLine(leftShoulder.first, leftShoulder.second-50, leftShoulder.second+20)
            drawDottedLine(rightShoulder.first, rightShoulder.second-50, rightShoulder.second+20)
        ...
        /*
        // Hiển thị bộ đếm Jumping Jack đúng/sai
        ...
        val correctText = "JumpingJack đúng: ${feedback?.correctCount ?: 0}"
        val incorrectText = "JumpingJack sai: ${feedback?.incorrectCount ?: 0}"
        val padding = 30f
