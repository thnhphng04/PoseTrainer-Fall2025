...
/**
 * MountainClimberOverlayView - Overlay view for Mountain Climber exercise
 * Dựa trên logic từ project Mountain Climber nghiên cứu
 */
class MountainClimberOverlayView @JvmOverloads constructor(
    context: Context,
        ...
        poseResult?.let { result ->
            ...
            if (landmarkList != null) {
                ...
                if (feedback?.isCameraWarning() == true) {
                    ...
                    // VẼ ĐẦY ĐỦ ĐỘNG TÁC MOUNTAIN CLIMBER
                    ...
                    // Vẽ đường nối vai - khuỷu tay - cổ tay (cánh tay)
                    ...
                    // Vẽ đường nối hông - đầu gối - mắt cá chân (chân)
                ...
                // Hiển thị bộ đếm Mountain Climber đúng/sai ở phía dưới cùng
                ...
                val correctText = "Mountain Climber đúng: ${feedback?.correctCount ?: 0}"
                val incorrectText = "Mountain Climber sai: ${feedback?.incorrectCount ?: 0}"
                val padding = 30f
