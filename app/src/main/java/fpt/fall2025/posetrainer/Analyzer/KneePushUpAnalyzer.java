...
/**
 * KneePushUp Analyzer - Phân tích bài tập Knee Push-Up
 * Implement ExerciseAnalyzerInterface để có thể sử dụng chung CameraFragment
 */
public class KneePushUpAnalyzer implements ExerciseAnalyzerInterface {

    private KneePushUpThresholds thresholds;
    ...
    public KneePushUpAnalyzer() {
        this.thresholds = KneePushUpThresholds.defaultBeginner();
    ...
    public KneePushUpAnalyzer(KneePushUpThresholds thresholds) {
        this();
    ...
    public Map<String, Object> getThresholds(String level) {
        ...
        if ("pro".equals(level)) {
            KneePushUpThresholds proThresholds = KneePushUpThresholds.defaultPro();
    ...
    // Inner class for KneePushUpThresholds
    public static class KneePushUpThresholds {
        ...
        public KneePushUpThresholds() {}

        public KneePushUpThresholds(int elbowNormal, int earElbowHipNormal, int[] earElbowHipTrans,
        ...
        public static KneePushUpThresholds defaultBeginner() {
            return new KneePushUpThresholds(
                    150, 120, new int[]{125, 150}, new int[]{155, 180},
                    120, 200, 150, 45, 15.0, 50
            );
        }

        public static KneePushUpThresholds defaultPro() {
            return new KneePushUpThresholds(
                    150, 120, new int[]{125, 150}, new int[]{155, 180},
