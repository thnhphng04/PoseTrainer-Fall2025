 ...
 */
public class InchWormAnalyzer implements ExerciseAnalyzerInterface {

    private InchWormThresholds thresholds;
    ...
    public InchWormAnalyzer() {
        this.thresholds = InchWormThresholds.defaultBeginner();
    ...
    public InchWormAnalyzer(InchWormThresholds thresholds) {
        this();
    ...
    public ExerciseFeedback analyze(List<Map<String, Float>> landmarks) {
        ...
        if (cameraWarning) {
            ...
            feedback.setCurrentState(currState + " " + hipAngle + " " + legWithVertical);
    ...
    public Map<String, Object> getThresholds(String level) {
        ...
        if ("pro".equals(level)) {
            InchWormThresholds proThresholds = InchWormThresholds.defaultPro();
    ...
    private String getState(int hipAngle, int legWithVertical) {
    ...
    // Inner class for InchWormThresholds
    public static class InchWormThresholds {
        ...
        public InchWormThresholds() {}

        public InchWormThresholds(int hipNormal, int hipTran, int legWithVerticalNormal, int legWithVerticalPass,
                                  int hipMax, int kneeMin, int offsetThresh, double inactiveThresh, int cntFrameThresh) {
