...
public class JumpingJackAnalyzer implements ExerciseAnalyzerInterface {
    ...
    public ExerciseFeedback analyze(List<Map<String, Float>> landmarks) {
        ...
        if (cameraWarning) {
            ...
            int leftElbowAngle = calculateAngle(leftShoulder, leftElbow, leftWrist);
            int leftKneeAngle = calculateAngle(leftHip, leftKnee, leftAnkle);
            ...
            int rightElbowAngle = calculateAngle(rightShoulder, rightElbow, rightWrist);
            int rightKneeAngle = calculateAngle(rightHip, rightKnee, rightAnkle);
            ...
            feedback.setLeftArmAngle(leftArmAngle);
            feedback.setLeftLegAngle(leftLegAngle);
            feedback.setRightArmAngle(rightArmAngle);
            feedback.setRightLegAngle(rightLegAngle);
