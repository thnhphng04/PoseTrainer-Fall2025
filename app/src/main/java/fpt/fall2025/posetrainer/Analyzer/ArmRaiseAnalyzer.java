 ...
 */
public class ArmRaiseAnalyzer implements ExerciseAnalyzerInterface {

    private ArmRaiseThresholds thresholds;
    ...
    public ArmRaiseAnalyzer() {
        this.thresholds = ArmRaiseThresholds.defaultBeginner();
    ...
    public ArmRaiseAnalyzer(ArmRaiseThresholds thresholds) {
        this();
    ...
    public Map<String, Object> getThresholds(String level) {
        ...
        if ("pro".equals(level)) {
            ArmRaiseThresholds proThresholds = ArmRaiseThresholds.defaultPro();
    ...
    // Inner class for ArmRaiseThresholds
    public static class ArmRaiseThresholds {
        ...
        public ArmRaiseThresholds() {}

        public ArmRaiseThresholds(int[] armThresholds,
