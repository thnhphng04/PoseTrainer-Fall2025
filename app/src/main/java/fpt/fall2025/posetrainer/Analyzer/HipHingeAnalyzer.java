 ...
 */
public class HipHingeAnalyzer implements ExerciseAnalyzerInterface {

    private HipHingeThresholds thresholds;
    ...
    public HipHingeAnalyzer() {
        this.thresholds = HipHingeThresholds.defaultBeginner();
    ...
    public HipHingeAnalyzer(HipHingeThresholds thresholds) {
        this();
    ...
    public ExerciseFeedback analyze(List<Map<String, Float>> landmarks) {
        ...
        int positionCheck = calculateAngleWithUpVertical(leftAnkle, leftHip);
    ...
    public Map<String, Object> getThresholds(String level) {
        ...
        if ("pro".equals(level)) {
            HipHingeThresholds proThresholds = HipHingeThresholds.defaultPro();
    ...
    private String getState(int hipAngle, float wristY, float ankleY, float footLength) {
        if (hipAngle > thresholds.getHipNormal()) {
            System.out.println("s1");
            return "s1";
        } else if (hipAngle < thresholds.getHipTran() && wristY > (ankleY - footLength*1)) {
    ...
    // Inner class for HipHingeThresholds
    public static class HipHingeThresholds {
        ...
        public HipHingeThresholds() {}

        public HipHingeThresholds(int hipNormal, int hipTran,
